    ...
    return (
        <main className="min-h-screen bg-white text-gray-800">
            <section className="relative w-full h-[45vh] flex bg-fixed bg-center items-center justify-center" style={{ backgroundImage: "url('/images/hakkimdaBg.png')" }}>
                ...
                <h1 className="relative z-10 text-[#2f3e46] text-2xl sm:text-3xl font-bold tracking-wide uppercase mt-12 text-center">{post.title}</h1>
            </section>

            <section className="py-16 bg-gray-50">
                <p className=" max-w-7xl mx-auto px-6 items-start text-base text-gray-500 mb-4">{post.date}</p>
                <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 items-start">
                    ...
                    <aside className="lg:col-span-4">
                        {/* Başlık hizalı olacak şekilde margin-top'ı sıfır */}
                            ...
                            {blogPosts.slice(0, 4).map((item) => (
                                <li key={item.slug}>
                                    ...
                                    >
                                        ...
                                        <p className="text-md font-medium text-[#2f3e46] leading-snug">{item.title}</p>
                                    </a>
                                </li>
                            ))}
                        </ul>
